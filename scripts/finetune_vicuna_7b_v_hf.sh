...
python /TTS_personal_jiahui.ni/Im-sys/FastChat/fastchat/train/train.py \
    ...
    --bf16 False \
    --output_dir /TTS_personal_jiahui.ni/Im-sys/FastChat/output_7b_ckp/ \
    --num_train_epochs 1 \
    ...
    --deepspeed /TTS_personal_jiahui.ni/Im-sys/FastChat/fastchat/train/vicuna-7b-deepseed-hf.json \
    --report_to none \
    --should_save True
